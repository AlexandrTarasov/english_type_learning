...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/php.vim/,~/.vim/plugged/dracula/,~/.vim/plugged/vim-blade/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/dracula/after,~/.vim/after
set shiftwidth=4
set showmatch
set smartindent
set splitright
...
set shortmess=aoO
badd +1 /var/www/blog.loc
badd +1 /var/www/advanced-english.loc
badd +7 /var/www/advanced-english.loc/resources/views/welcome.blade.php
badd +0 /var/www/advanced-english.loc/resources/views/frontside/header.blade.php
badd +0 /var/www/advanced-english.loc/app/Http/Controllers/PageController.php
argglobal
silent! argdel *
edit /var/www/advanced-english.loc/app/Http/NetrwTreeListing\ 9
...
exe 'vert 2resize ' . ((&columns * 66 + 75) / 150)
exe 'vert 3resize ' . ((&columns * 61 + 75) / 150)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
20
normal! 0
lcd /var/www/advanced-english.loc/app/Http/Controllers
wincmd w
argglobal
if bufexists('/var/www/advanced-english.loc/app/Http/Controllers/PageController.php') | buffer /var/www/advanced-english.loc/app/Http/Controllers/PageController.php | else | edit /var/www/advanced-english.loc/app/Http/Controllers/PageController.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('/var/www/advanced-english.loc/resources/views/frontside/header.blade.php') | buffer /var/www/advanced-english.loc/resources/views/frontside/header.blade.php | else | edit /var/www/advanced-english.loc/resources/views/frontside/header.blade.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((26 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
normal! 042|
lcd /var/www/advanced-english.loc/resources/views/frontside
wincmd w
3wincmd w
exe 'vert 1resize ' . ((&columns * 21 + 75) / 150)
exe 'vert 2resize ' . ((&columns * 66 + 75) / 150)
