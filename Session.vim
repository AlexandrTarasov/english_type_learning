...
nnoremap <silent> <Plug>NetrwReturn :Rexplore
nmap <silent> <2-LeftMouse> <Plug>NetrwReturn
map <S-Insert> <MiddleMouse>
...
imap  <Plug>TComment_
inoremap ;li o<li></li>F>a
inoremap ;ul <ul><li></li></ul><++>03kf<i
inoremap ;a <a href=""><++></a> <++>F"i
inoremap ;p <p></p><++>02kf>a
inoremap ;d <div class=""></div><++>2kf<i
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set report=10000
set ruler
set runtimepath=~/.vim,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/vim-javascript-syntax/,~/.vim/plugged/vim/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set showmatch
set smartindent
set splitright
set statusline=%f[%{strlen(&fenc)?&fenc:'none'},%{&ff}]%y%h%m%r\ %=Line:%l/%L[%p%%]\ Col:%c\ Buf:%n\ [%b][0x%B]\ 
...
set shortmess=aoO
badd +1 /media/alex/1C5036035035E3E4/0-Studying/English
badd +1 /var/www/advanced-english.loc
badd +0 /var/www/advanced-english.loc/database/migrations/2018_03_01_214307_create_categories_table.php
badd +0 /var/www/advanced-english.loc/app/Http/Controllers/Admin/CategoryController.php
badd +0 /var/www/advanced-english.loc/routes/web.php
badd +1 /var/www/advanced-english.loc/resources/views/layouts/app.blade.php
badd +16 /var/www/advanced-english.loc/resources/views/admin/layouts/app_admin.blade.php
badd +1 /var/www/advanced-english.loc/resources/views/admin/categories/index.blade.php
badd +0 /var/www/index.blade.php
badd +1 /var/www/advanced-english.loc/resources/views/admin/breadcrumb.blade.php
badd +1 /var/www
badd +4 /var/www/breadcrumb.blade.php
badd +1 /var/www/advanced-english.loc/resources/views/admin/components/sds.php
badd +0 /var/www/advanced-english.loc/resources/views/admin/components/breadcrumb.blade.php
argglobal
silent! argdel *
set stal=2
edit /var/www/advanced-english.loc/resources/views/admin/components/NetrwTreeListing\ 123
...
40
normal! 014|
lcd /var/www/advanced-english.loc/resources/views/admin/components
wincmd w
argglobal
if bufexists('/var/www/advanced-english.loc/resources/views/admin/categories/index.blade.php') | buffer /var/www/advanced-english.loc/resources/views/admin/categories/index.blade.php | else | edit /var/www/advanced-english.loc/resources/views/admin/categories/index.blade.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
1
normal! 0
lcd /var/www/advanced-english.loc/resources/views/admin/categories
wincmd w
exe 'vert 1resize ' . ((&columns * 30 + 82) / 164)
exe 'vert 2resize ' . ((&columns * 133 + 82) / 164)
tabedit /var/www/advanced-english.loc/resources/views/admin/components/breadcrumb.blade.php
set splitbelow splitright
set nosplitbelow
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
...
normal! 040|
lcd /var/www/advanced-english.loc/resources/views/admin/components
tabedit /var/www/advanced-english.loc/app/Http/Controllers/Admin/CategoryController.php
set splitbelow splitright
set nosplitbelow
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((6 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
normal! 05|
lcd /var/www/advanced-english.loc/app/Http/Controllers/Admin
tabnext 1
set stal=1
